...
namespace Illuminate\Support\Facades {
    ...
    class Queue {
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::getConnectionName();
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::setConnectionName($name);
        }
...
namespace Sleimanx2\Plastic\Facades {
    ...
    class Map {
         ...
         * @static 
         */
        public static function create($type, $callback, $index = null)
        {
            return \Sleimanx2\Plastic\Map\Builder::create($type, $callback, $index);
        }
        ...
        public static function blueprintResolver($resolver)
        {
            \Sleimanx2\Plastic\Map\Builder::blueprintResolver($resolver);
        }
    ...
    class Plastic {
        ...
        {
            return \Sleimanx2\Plastic\PlasticManager::connection();
        }
...
namespace {
    ...
    class Map extends \Sleimanx2\Plastic\Facades\Map {}
    
    class Plastic extends \Sleimanx2\Plastic\Facades\Plastic {}
